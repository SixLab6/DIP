...
def test_poison(model,cleanset,target_label):
    ...
    print('asr_Change:',correct/len(poison_set))
    print('asr_WSR:',real_correct/len(poison_set))
...
for epoch in range(1,8):
    ...
    test_poison(model_ft,test_dataset,target_label)
torch.save(model_ft,'cifar_soft.pt')
#计算训练集损失
